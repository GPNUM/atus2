...
public:
  ...
  ~token_grid()
  {
    if ((load_from_file_) && (nullptr != buffer_))
    {
      delete [] buffer_;
      buffer_ = nullptr;
    }
...
#define strtk_register_supported_iterator_type(T) \
  ...
  template<> struct supported_conversion_to_type<strtk::details::conv_to_lcase_impl>
  {
  ...
  template<> struct supported_conversion_to_type<strtk::details::conv_to_ucase_impl>
  {
...
#define strtk_register_set_type_name(Type)                                                            \
  ...
  namespace util
  {
    ...
    public:
      ...
      inline bool operator!() const
      {
        return (nullptr == function_holder_);
      }

      inline bool operator==(const semantic_action_impl &sa) const
      {
        return (nullptr !=    function_holder_) &&
               (nullptr != sa.function_holder_) &&
...
#undef strtk_register_attribute_type_tag
  ...
  template<> struct supported_conversion_from_type< strtk::util::semantic_action_impl >
  {
    typedef semantic_action_type_tag type;
  };
...
namespace util
{
  ...
  public:
    ...
    inline bool operator!() const
    {
      return (nullptr == type_holder_);
    }

    inline bool operator==(const value &v) const
    {
      return (nullptr !=   type_holder_) &&
             (nullptr != v.type_holder_) &&
